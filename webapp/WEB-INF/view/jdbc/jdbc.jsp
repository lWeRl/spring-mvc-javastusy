            ...
            <div class="row">
                ...
                <div class="col-md-3">
                    <div class="list-group">
                        ...
                        <a href="${jdbcUpdate}/user/username/javastudy@outlook.com/enabled/false" class="list-group-item">Update User</a>
                    </div>
                </div>
                <!-- Content Column -->
                <div class="col-md-9">
                    <%--@elvariable id="resultObject" type="org.lwerl.mvcjavastudy.mvc.jdbc.JDBCController"--%>
